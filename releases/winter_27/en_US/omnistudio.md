...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Reuse the auto-launched flow logic in your FlexCards (generally available)** | ✅ | ❌ | ❌ | ❌ | [🔗](https://help.salesforce.com/s/articleView?id=release-notes.rn_omnistudio_flexcard_autolaunched_flow.htm&language=pt_BR&release=264&type=5) |
| **Run FlexCards and OmniScripts offline on mobile devices** | ✅ | ❌ | ❌ | ❌ | [🔗](https://help.salesforce.com/s/articleView?id=release-notes.rn_omnistudio_flexcard_omniscript_offline_mobile.htm&language=pt_BR&release=264&type=5) |
| **OmniStudio Minor Versions** | ❌ | ❌ | ❌ | ✅ | [🔗](https://help.salesforce.com/s/articleView?id=release-notes.rn_omnistudio_updates_minor_releases.htm&language=pt_BR&release=264&type=5) |
