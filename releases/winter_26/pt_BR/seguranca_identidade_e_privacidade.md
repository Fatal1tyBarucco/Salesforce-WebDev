...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **<..td class="slds-cell-wrap" style="text-align:center;vertical-align:top;" headers="rn_feature_impact__byRequest ">** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Configurar ou migrar recursos e notificações móveis usando a estrutura de aplicativo cliente externo** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Detecção de dados (disponível ao público em geral)** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Fim do suporte do pacote gerenciado da Detecção de dados na versão Spring '26** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Criptografe organizações pessoais do Tableau com a Criptografia de plataforma para Data Cloud** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Criptografe campos em novos objetos de perfil de crédito no Automotive Cloud** | ❌ | ❌ | ✅ | ❌ | |
| **Central de segurança** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Acompanhe as métricas do Agentforce para melhorar sua postura de segurança** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
