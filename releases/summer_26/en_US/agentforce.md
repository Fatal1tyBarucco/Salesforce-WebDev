...
> **66 features** | 🔴 1 alto impacto | 🟡 0 médio | 🟢 0 baixo

A categoria Agentforce no Summer '26 redefine a automação inteligente ao integrar capacidades conversacionais avançadas e autonomia operacional diretamente nos fluxos de trabalho do Salesforce. A principal mudança consolida o canal de voz como um meio nativo para agentes autônomos de IA, acelerando a resolução de casos e humanizando a experiência do cliente.

| Feature | Descrição | Impacto |
| :--- | :--- | :---: |
| **Voice feature** — _usuários, admins_ | Capacita os agentes autônomos do Agentforce a processar e responder a interações de voz em tempo real com compreensão de… | 🔴 alto |
