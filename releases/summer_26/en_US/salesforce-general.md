...
| **Acompanhe seus créditos da MuleSoft na Digital Wallet** | ❌ | ❌ | ✅ | ❌ | |
| **Atualize seus pipelines de dados para a migração de armazenamento de transcrição de chat** | ❌ | ✅ | ❌ | ❌ | |
| **Descontinuação e redirecionamento de PDF** | ❌ | ✅ | ❌ | ❌ | |
| **Arquivar aplicativo** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Monitore o progresso do arquivo com novos status de atividade** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Gerenciar dados com mais eficiência com as novas configurações do aplicativo Arquivar** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Acessar Arquivar dados 2.0 no Salesforce Classic** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Renomear recursos do aplicativo de arquivo para se alinhar aos padrões do Salesforce** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Prepare-se para a descontinuação de seu próprio pacote gerenciado de arquivo e arquivo legado** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Simplifique o faturamento gerenciando suas faturas no Salesforce Foundations** | ❌ | ❌ | ✅ | ❌ | |
...
| **Salesforce Meu centro de Trust** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
