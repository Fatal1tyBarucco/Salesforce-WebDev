...
* **Acessar o Salesforce em mais regiões com o Hyperforce** — _Requer configuração_

* **Novos produtos e recursos disponíveis na Defesa do Government Cloud** — _Requer configuração_

* **A continuidade avançada entre regiões alcança objetivos de recuperação mais rápidos** — _Contatar Salesforce_
