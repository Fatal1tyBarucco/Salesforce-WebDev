...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Agentes de vendas de IA** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Engajamento do Agentforce** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Melhore a qualidade do resumo de vendas com instruções avançadas do modelo de prompt** | ❌ | ✅ | ❌ | ❌ | |
| **Aplicativo Agentforce Sales em Gemini (beta)** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Trabalhe mais rapidamente com uma interface de planejamento de território modernizada** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Evite conflitos de regra com a visibilidade de regra de segmento aprimorada** | ❌ | ❌ | ✅ | ❌ | |
| **Diferenciar metas de vendas com metas de moeda e quantidade** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **A versão 1 do Planejamento de vendas está agendada para descontinuação** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Salesforce Spiff** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Importar domínios de email autorizados para um sandbox** | ❌ | ✅ | ❌ | ❌ | |
...
| **Dados de evento agora são armazenados na Salesforce Platform** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
