...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Notas de versão mensal do serviço** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| Recurso | Usuários | Admins | Config | Contato | Docs |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Estender o temporizador de expiração para componentes de mensagens enviados por fluxos dinâmicos do WhatsApp** | ❌ | ✅ | ❌ | ❌ | |
...
| **Processe pagamentos indianos perfeitamente em conversas do WhatsApp** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Usar novos campos de DMO de Engajamento de mensagens** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Prepare-se para alterações de nome de usuário do WhatsApp** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Canais do Facebook Messenger padrão deixarão de funcionar em junho** | ❌ | ❌ | ✅ | ❌ | |
| **Canais de SMS padrão deixarão de funcionar em julho** | ❌ | ❌ | ✅ | ❌ | |
| **Marcar sessões de mensagens abandonadas como inativas** | ❌ | ✅ | ❌ | ❌ | |
| **O Chat legado está sendo descontinuado** | ✅ | ❌ | ❌ | ❌ | |
| **Bring Your Own Channel** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Traga seu próprio bot** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Gerenciamento de ativos de hardware de TI do Agentforce (disponível ao público em geral)** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Conformidade de TI (disponível ao público em geral)** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Analisar o desempenho operacional e o inventário do ativo de TI com o painel do CMDB Analytics** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Visualizar o Survey Analytics com painéis do Tableau Next** | ❌ | ✅ | ❌ | ❌ | |
| **Serviço de RH** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Colocar a IA agente para trabalhar em tarefas de RH comuns com uma biblioteca de agentes pré-criada** | ✅ | ❌ | ❌ | ❌ | |
| **Insights de serviço** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Personalizar aplicativos do Tableau Next Analytics para seus negócios** | ❌ | ✅ | ❌ | ❌ | |
| **Resposta de serviço** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
