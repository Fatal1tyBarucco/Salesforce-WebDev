...
| **Otimização de planilhas de horas e custos trabalhistas** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Comunicações** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Agentforce para cotação corporativa** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Automatize a cotação corporativa com ações invocáveis para fluxos assistidos pelo agente** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Novas ações invocáveis no Gerenciamento de vendas Enterprise** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **O Assistente de uso e faturamento foi descontinuado** | ❌ | ✅ | ❌ | ❌ | |
| **Gerenciamento de vendas empresariais** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Automatize recriações de cotação complexas usando APIs de clone profundo** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Lide com várias criações e envios de subpedido simultaneamente** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Atribuir valores de membro a atributos somente leitura e ocultos em cotações corporativas** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Capture e reutilize configurações de produto com modelos de carrinho** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Controlar ações do Visualizador do ativo com uma permissão personalizada** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Ler dados mais facilmente com layouts de tabela otimizados** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Cotação rápida do Einstein para o Gerenciamento de vendas corporativas está programada para descontinuação** | ❌ | ❌ | ✅ | ❌ | |
| **Outras alterações no Gerenciamento de vendas Enterprise** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Revenue Cloud para comunicações na Salesforce Platform** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Gerenciar cotações e pedidos com o editor de linha aprimorado** | ✅ | ❌ | ❌ | ❌ | |
| **Multisite no Revenue Cloud para comunicações** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Assinante múltiplo no Revenue Cloud para comunicações** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Vendas do consumidor no Revenue Cloud para comunicações** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **APIs REST do Connect novas e alteradas para Educação** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Energia e serviços essenciais** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Objetos novos e alterados em Energy & Utilities** | ❌ | ❌ | ✅ | ❌ | |
| **Serviços financeiros** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Recursos de Serviços financeiros lançados por mês** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Agentforce para serviços financeiros** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Assistência de serviço bancário** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Validação de documentos habilitados por IA** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Mostrar aos representantes da central de contato do contribuinte resumos gerados por IA unificada** | ❌ | ❌ | ✅ | ❌ | |
| **Comparar planos de seguro e gerar cotações com o Seguro de saúde digital** | ❌ | ❌ | ✅ | ❌ | |
| **Engajamento de saúde** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Gerenciamento de cuidados integrado** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Personalize planos de cuidados mais rapidamente com recomendações de meta direcionadas** | ❌ | ❌ | ✅ | ❌ | |
| **Gerenciamento de indicação** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Automatizar verificações de necessidade de autorização prévia** | ❌ | ❌ | ✅ | ❌ | |
| **Acompanhe o progresso da indicação com planos de ação** | ❌ | ❌ | ✅ | ❌ | |
...
| **Gerenciamento de reclamações** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Objetos novos e alterados em Seguro** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Novas APIs REST do Connect em Seguro** | ❌ | ✅ | ❌ | ❌ | |
| **Corpos de solicitação da API REST do Connect alterados** | ❌ | ✅ | ❌ | ❌ | |
| **Corpos de resposta da API REST do Connect alterados** | ❌ | ✅ | ❌ | ❌ | |
| **Ações invocáveis alteradas no seguro** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Novos tipos de metadados em seguro** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Novo objeto da API do conjunto de ferramentas em Seguro** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Life Sciences** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Simplificar o planejamento e a execução de eventos** | ❌ | ✅ | ❌ | ❌ | |
...
| **Transformar dados da conta em resumos prontos para visita** | ❌ | ✅ | ❌ | ❌ | |
| **Gerenciar melhor contas-chave com objetos de modelo de dados e filtros de pesquisa** | ❌ | ✅ | ❌ | ❌ | |
...
| **Contas de doutorado institucionais** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Filtragem de território do modelo de email aprimorada no aplicativo móvel** | ❌ | ❌ | ✅ | ❌ | |
| **Engajamento do paciente** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Conformidade de engajamento do provedor** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Atualizar arquivos LifeSciConfigRecord para o novo formato de nomenclatura de perfil** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Gerenciar declarações de garantia e cobertura** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Simplificar operações de vendas do revendedor** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Gerar conversão de pedido mais rápida de amostras** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Simplificar operações de aquisição para recebimento do distribuidor** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Aplicativos Tableau Next para manufatura** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Rastrear contas-chave e o desempenho do acordo de vendas** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Analisar seus fluxos de receita de serviço** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Traduzir dados em percepções com o Datakit de gerenciamento de garantia** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Simplificar a configuração de manufatura com o Salesforce Go** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Padronizar o início da declaração de boa vontade com o modelo de processo de serviço predefinido** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Aumente a eficiência do parceiro com o Gerenciamento de canal aprimorado** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Objetos novos e alterados para manufatura** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Planejamento de mídia para produtos de mídia lineares** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Gerenciamento de ciclo de vida da assinatura** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Novas ações invocáveis no Agentforce Media** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
...
| **Agendar compromissos no setor público da Agentforce com agendamento de trabalho (disponível ao público em geral)** | ❌ | ❌ | ✅ | ❌ | |
...
| **API REST do Filtrar e Pesquisa baseada em critérios alterada** | ❌ | ✅ | ❌ | ❌ | |
...
| **Automatize recriações de pedido e cotação complexas que usam clonagem profunda de precisão** | ❌ | ✅ | ❌ | ❌ | |
...
| **Extrair cláusulas de regulamentação e apólice com IA generativa** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Impor requisitos de conformidade com a assistência de conformidade** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Automatizar controles de conformidade com modelos de prompt** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Simplificar o mapeamento de conformidade com a análise de impacto** ⚠️ | ❌ | ❌ | ❌ | ❌ | |
| **Novas APIs REST do Connect para o Process Conformity Navigator** | ❌ | ✅ | ❌ | ❌ | |
