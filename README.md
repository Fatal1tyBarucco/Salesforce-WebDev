...
Este repositório armazena as notas de versão extraídas automaticamente do Salesforce Help.
...
### Spring 25
- [apex](./releases/spring_25/apex.md)
- [flow](./releases/spring_25/flow.md)
- [integrations](./releases/spring_25/integrations.md)
- [lwc](./releases/spring_25/lwc.md)
- [security](./releases/spring_25/security.md)
