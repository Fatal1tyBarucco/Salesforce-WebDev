...
**Dependências:** `src/auto_healing/` (webhook.py, github_service.py, agent_core.py, models.py)

**Status:** ✅ Completo - Agosto 2026

**Documentação:**
- [Visão Geral](../auto-healing/index.md)
- [Arquitetura Deep Dive](../auto-healing/architecture/deep-dive.md)
- [Guia de Deploy](../auto-healing/deployment/guide.md)
- [Runbook de Operação](../auto-healing/runbooks/auto-healing-agent.md)
- [ADR-004](../architecture/decisions/adr-004-auto-healing-agent.md)
