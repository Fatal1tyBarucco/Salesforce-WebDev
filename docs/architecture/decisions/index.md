...
Decisões de design documentadas do projeto Salesforce Release Intelligence.

## ADRs Publicadas

- **[ADR-001 Parser Strategy](adr-001-parser-strategy.md)** — Estratégia de parsing: árvore de navegação e tabelas de feature impact
